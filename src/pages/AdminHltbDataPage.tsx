...
import { Clock, BarChart, AlertTriangle, AlertCircle, Filter, RefreshCw } from "lucide-react";
      ...
      <div className="container max-w-7xl mx-auto px-4 py-24">
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Manage and monitor HowLongToBeat data, and other metadata integrations for your game catalog.
          </p>
        </div>
