...
BEGIN
  ...
  -- 2. Quality Score (shame-based: high quality unplayed = more dust)
  -- Games WITHOUT Metacritic scores get benefit of the doubt (lowest tier)
  -- so indie/niche games aren't unfairly penalized
  quality_score := CASE
    WHEN metacritic_score IS NULL THEN 6
